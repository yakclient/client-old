...
//        check(dependencies.all { it is ResolvedJpm }) { "Only JPM dependencies are supported!" }
//        val jpmDeps = dependencies as List<ResolvedJpm>
//
//        val module = parent::class.java.module
//        val config: Configuration = Configuration.resolve(
//            ProvidedModuleFinder(ref),
//            jpmDeps.map(ResolvedJpm::configuration) + module.layer.configuration(),
//            ModuleFinder.of(),
...
//            config,
//            jpmDeps.map(ResolvedJpm::layer) + module.layer,
//            parent.loader
//        )
//
